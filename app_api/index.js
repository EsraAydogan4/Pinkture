...
// const User = require("./src/models/userPageSchema.js");
...
//   })
  .then(() => {
    ...
    //   res.json({ success: true, message: "Kullanıcı girişi başarılı." });
    // });
    ...
    // app.post("/pages/userSettings", (req, res) => {
    ...
    // app.put("/pages/userSettings/:usersId", (req, res) => {
    //   //body nesnesinde tüm bilgiler var konsolda görebilirsin.
    //   //aşağıda değişken olarak ekli. Buradaki bilgileri alıp şemana gönderip kaydedebilirsin.
    ...
    // // });
    // app.get("/pages/userSettings/:usersId", (req, res) => {
    //   const userId = req.params.usersId;
    
    //   // Kullanıcının profil ayarlarını veritabanından çekme işlemi
    //   UserSettings.findById(userId, (err, userSettings) => {
    //     if (err) {
    //       console.error(err);
